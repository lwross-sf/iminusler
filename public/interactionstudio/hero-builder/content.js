...
function renderSessions(products, data){
  ...
  for (j = 0; j < data.length; j++) {
    ...
    for (k = 0; k < data[j].events.length; k++) {
      var userAction = data[j].events[k].userAction;
      if(userAction=='Purchase' || userAction=='Update Cart' || userAction=='View Item'){
      ...
      } else if(userAction=='Page View'){
        htm += viewRow.replace('{name}', data[j].events[k].page)
        .replace('{time}', data[j].events[k].viewTime/1000)
      } else {
        htm += customRow.replace('{name}', data[j].events[k].userAction)
        .replace('{time}', data[j].events[k].viewTime/1000)
      }
    }
...
function renderSessionsTemplates(products){
  ...
  sessionOneTemplate = sessionTop.replace('{index}', "1").replace('{time}', "").replace('{hide}', "slds-hide") + sessionEvents.replace('{action}', "")
  .replace('{type}', "")
  .replace('{item}', "")
  .replace('{time}', "10")
  .replace('{typeList}', selectType)
...
function renderHeroTemplate(users, products){
  ...
  heroTemplate = heroScreen.replace('{itemList}', selectItem).replace('{session}', sessionOneTemplate);
  heroModalTemplate = heroModal.replace('{heroList}', selectHero);
}
    ...
    <div class="slds-expression__options slds-size_1-of-1 slds-grid slds-wrap">
      <div class="slds-form-element slds-size_1-of-3">
        <label class="slds-form-element__label" for="text-input-id-1">
          <abbr class="slds-required" title="required">* </abbr>Session Start Timestamp
        </label>
    ...
    <div class="slds-size_1-of-1 slds-grid slds-wrap" role="event-row">
      <div class="slds-form-element slds-size_1-of-6 slds-p-right_small">
        <div class="slds-form-element__control">
          <div class="slds-select_container">
            <select class="slds-select" role="event-action-type" onchange="selectCustomAction(this)">
              <option value="Page View" selected>Page View</option>
              <option value="Custom">Custom</option>
            </select>
          </div>
        </div>
      ...
      <div class="slds-form-element slds-size_7-of-12 slds-p-right_small">
        <div class="slds-form-element">
          <div class="slds-form-element__control">
            <input type="text" placeholder="Page Name" required="" role="event-item-custom" value="{name}" class="slds-input" />
          </div>
        </div>
      </div>
      <div class="slds-form-element slds-size_1-of-6 slds-p-right_small">
        <div class="slds-form-element__control">
          <input type="number" role="event-time" placeholder="Time in seconds" required="" class="slds-input" value="{time}" min="0" max="600"/>
        </div>
      </div>
      <div class="slds-form-element slds-size_1-of-12">
        <div class="slds-form-element__control">
...
const heroScreen = `                      <!-- User Attributes -->
<div class="slds-col slds-size_1-of-1 slds-grid slds-wrap slds-p-vertical_medium slds-p-horizontal_x-large" aria-label="section-user-attributes">
  ...
  <div class="slds-col slds-size_1-of-4 slds-text-align_right">
    <div class="slds-button-group" role="group">
      <button onclick="showHeroPicker(this)" class="slds-button slds-button_neutral">Use Template</button>
      <div class="slds-dropdown-trigger slds-dropdown-trigger_click slds-button_last">
        ...
        <div class="slds-dropdown slds-dropdown_right">
          <ul class="slds-dropdown__list" role="menu" aria-label="Show More">
            ...
            <li class="slds-dropdown__item" role="presentation">
              <a onclick="showDeleteModal(this)" role="menuitem" tabindex="-1">
...
<!--// User Attributes -->
<!-- Select Product -->
<div class="slds-col slds-size_1-of-1 slds-grid slds-wrap slds-p-top_medium" aria-label="section-user-product">
  <div class="slds-col slds-size_1-of-1 slds-grid slds-grid_align-center slds-p-around_large" style="background-color: #16325c;">
    <div class="slds-form-element slds-size_5-of-12">
      <label class="slds-form-element__label slds-text-color_inverse">
        <abbr class="slds-required" title="required" style="color:white !important;">* </abbr>Pick your Featured Catalog Item
      </label>
      <div class="slds-form-element__control">
        <div class="slds-select_container">
    ...
    <div class="slds-form-element slds-size_1-of-8 slds-p-left_medium slds-text-align_left">
      <label class="slds-form-element__label slds-text-color_inverse">&nbsp;</label>
      <div class="slds-form-element__control">
        <button onclick="submitHero(this)" class="slds-button slds-button_brand">Build Events</button>
      </div>
    </div>
  </div>
</div>
<!--// Select Product -->
<!-- User Sessions -->
<div class="slds-col slds-size_1-of-1 slds-grid slds-wrap slds-p-horizontal_x-large" aria-label="section-user-sessions">
  ...
  <div class="slds-expression slds-size_1-of-1">
    <ul role="session-row">{session}</ul>
    <div class="slds-expression__buttons">
...
<section role="dialog" tabindex="-1" aria-label="Delete confirmation" aria-modal="true" aria-describedby="modal-content-id-1" class="slds-modal slds-fade-in-open">
  <div class="slds-modal__container" style="width:400px; min-width:400px;">
    <header class="slds-modal__header">
      ...
      <h2 id="modal-heading-01" class="slds-modal__title slds-hyphenate">Pick your hero template</h2>
    </header>
    <div class="slds-modal__content slds-p-around_medium" id="modal-content-id-1">
      <div class="slds-col slds-size_1-of-1 slds-grid slds-wrap" aria-label="hero-picker-options">
